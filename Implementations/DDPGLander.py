...
agent = Agent(actor_lr, critic_lr, soft_target_update, input_dimensions,               env.action_space.shape[0], discount_factor,               hlOne, hlTwo, int(buffer_size), minibatch_size)
